...
You also don't need to be comfortable with Git and GitHub.
...
Reproducibility has been taken to mean a variety of things, but here I go by this definition:
...
# Project set-up
Most of what we'll cover today does not actually involve much code--we'll mostly work on setting up projects with reproducibility in mind^[You can also automate some of this stuff with the `rrtools` package, but for a basic project like this we can take things a bit slower].
In this section, we'll discuss :

1. how to **document your projects** such that everyone (including future you) will be better able to understand and reproduce your work and
2. how to **organise your projects** such that they are easy to share and to navigate

## Documentation
Good documentation is vital for making your work accessible.
Accessibility in the context of data and code can refer to many things: Is something available online? Is it easy to find? Is it shared in a non-proprietary format?
But even when code and data meet all those criteria, I would say that they're not accessible if people don't understand them or don't know how to use them.
...
Because you hold the copyright to your work^[In fact, it is often your university or institute that holds the copyright to the work you created while working there], anyone who wants to use your work should technically ask for your permission to be able to do so.
...
3. Tick the box next to this file to `add` it.
...
Now we have a portable, well-documented project to work with!
...
That's because software versions can easily break your code.
