...
The difference should becie more obvious when looking at this chart from the [Turing Way](https://the-turing-way.netlify.app/reproducibility/03/definitions) [@turing_way2019]:
...
## Documentation
Now that our project is set up, it's really important to have good documentation.
