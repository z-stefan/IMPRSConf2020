...
```
Hint 1: you don't need to set the working directory anymore, R Projects do that for you.
Hint 2: you might want to use the `here` package^[if you do, don't forget to include it in the 'Load packages' section] to create the relative paths.
